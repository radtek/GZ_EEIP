  ...
  <body>
    ...
    <ion-content has-header="true" padding="true">
      <div style="text-align: center; width: 100%;">
        <img src="${pageContext.request.contextPath}/test/app/ionic/images/success.png" style="width: 100px; height: 100px; margin-top: 50px;"/><br><br>
        <span style="font-size: 20px;">重置成功</span><br><br><br><br>        
