...
<body>
    <div class="crumbs-nav">
        <p class="crumbs-text">
			当前位置：<a>取证及流程管理</a><span>></span><a>已出库检材</a>
        </p>
    </div>
...
<!--             	<tr>
    ...
    <script>
	   	...
	   	function view(id){
    		var url = "${pageContext.request.contextPath}/evidenceMgt/outOfTheLibrary/outOfTheLibraryViewer.do?id="+id;
    	...
    	$(function(){
    		...
    		function loadGridData() {
    			...
    			dataTable.initialize({
    				...
    				"dataSource" : "${ pageContext.request.contextPath }/elecEVIDMgt/appraisal/appraisalOutputList.do",
