 ...
 */
@Entity
@Table(name = "t_annual_plan_att")
public class AnnualPlanAtt extends BaseEntity implements Serializable {

	private static final long serialVersionUID = -5805270901249980583L;
	...
	private Integer delFlag = AnnualPlanAtt.NORMAL;
	
	/***
	 * 内部审核实施计划申请ID
	 */
	@Column(name = "fk__annual_plan_app_id", length = 32, nullable = false)
	private String annualPlanAppId;
	
	public AnnualPlanAtt(){
