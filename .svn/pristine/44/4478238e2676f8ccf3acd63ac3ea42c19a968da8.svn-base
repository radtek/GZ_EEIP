...
<body>
    <div class="crumbs-nav">
        <p class="crumbs-text">
			当前位置：<a>取证及流程管理</a><span>></span><a>检材交接记录</a>
        </p>
    </div>
    ...
    <script>
	   	function view(id){
    		var url = "${pageContext.request.contextPath}/evidenceMgt/handoverRecord/handoverRecordViewer.do?id="+id;
    	...
    	$(function(){
    		...
    		function loadGridData() {
				...
				var columns = [
					...
					{ "mData" : "evidName" , "bSortable" : false },
    			...
    			dataTable.initialize({
    				...
    				"dataSource" : "${ pageContext.request.contextPath }/elecEVIDMgt/appraisal/appraisalConnectList.do",
