...
<body>
    <div class="crumbs-nav">
        <p class="crumbs-text">
           	当前位置：<a>人员信息管理</a><span>></span><a>培训计划</a>
        </p>
   	</div>
   <div class="operating-area">
    	...
    	<sys:auth grant="TRAINING_PLAN_MGT_ADD" username="${sessionScope.loginUser.userName}">
	    	<div class="button-content">
    ...
    <script>
	    ...
	    function view(id){
		    $('.index-iframe' , window.parent.document ).attr('src', '${pageContext.request.contextPath}/psnlInfo/trainingPlan/trainingPlanInfoView.do?id='+id);
		}
	    
	    function modify(id){
		    $('.index-iframe' , window.parent.document ).attr('src', '${pageContext.request.contextPath}/psnlInfo/trainingPlan/trainingPlanInfoForm.do?id='+id);
		}
	    ...
	    $(function(){
	    	...
	    	$('.add-form-btn').click(function() {
	  	        $('.index-iframe' , window.parent.document ).attr('src', '${pageContext.request.contextPath}/psnlInfo/trainingPlan/trainingPlanInfoForm.do');
	        });
	        ...
	        function loadGridData() {
	            ...
	            dataTable.initialize({
	                ...
	                "dataSource" : "${pageContext.request.contextPath}/psnlInfo/trainingPlanAppGirdData.do",
	                ...
	                "url" : {
	      		      ...
	      		      "rmDataUrl" : "${pageContext.request.contextPath}/psnlInfo/removeTrainingPlanAppData.do"
	    	           }
	    	       });
