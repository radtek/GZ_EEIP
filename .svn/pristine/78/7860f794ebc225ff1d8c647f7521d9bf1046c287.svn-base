...
(function ($) {
    ...
    $.fn.jqGrid = function( pin ) {
        ...
        return this.each( function() {
            ...
            var p = $.extend(true,{}, $.jgrid.jqGrid_setting, $.jgrid.defaults, pin || {});
            var ts= this, grid={
                headers:[],
                cols:[],
                footers: [],
            ...
            if( ts.p.toolbar[0] ) {
                ...
                if(ts.p.toolbar[1]==="both") {
                    ...
                    $(grid.uDiv).width("100%").addClass("ui-userdata ui-state-default").attr("id","t_"+this.id);
                }
            ...
            if(ts.p.toppager) {
                ...
                $(grid.topDiv).addClass('ui-state-default ui-jqgrid-toppager').width("100%").insertBefore(grid.hDiv);
                setPager(ts.p.toppager,'_t');
            }
            if(ts.p.footerrow) {
                grid.sDiv = $("<div class='ui-jqgrid-sdiv'></div>")[0];
                hb = $("<div class='ui-jqgrid-hbox"+(dir==="rtl"?"-rtl":"")+"'></div>");
                $(grid.sDiv).append(hb).width("100%").insertAfter(grid.hDiv);
                $(hb).append(tfoot);
        ...
        return this.each( function() {
            ...
            this.createTableForGroup = function(group, parentgroup) {
                ...
                if(this.p.ruleButtons === true) {
                    ...
                    var inputAddRule = $("<input type='button' value='新增条件' title='Add rule' class='add-rule ui-add'/>"), cm;
...
(function($){
    ...
    $.jgrid.extend({
        searchGrid : function (p) {
            p = $.extend(true,{}, $.jgrid.searchGrid_setting, $.jgrid.search, p || {});
            return this.each(function() {
                var $t = this;
                if(!$t.grid) {return;}
        ...
        editGridRow : function(rowid, p){
            p = $.extend(true,{}, rowid==="new"?$.jgrid.editGridRow_setting_new:$.jgrid.editGridRow_setting_edit, $.jgrid.edit, p || {});
            rp_ge[$(this)[0].p.id] = p;
            return this.each(function(){
                var $t = this;
        ...
        viewGridRow : function(rowid, p){
            p = $.extend(true,{}, $.jgrid.viewGridRow_setting, $.jgrid.view, p || {});
            rp_ge[$(this)[0].p.id] = p;
            return this.each(function(){
                var $t = this;
                if (!$t.grid || !rowid) {return;}
        ...
        delGridRow : function(rowids,p) {
            p = $.extend(true,{}, $.jgrid.delGridRow_setting, $.jgrid.del, p ||{});
            rp_ge[$(this)[0].p.id] = p;
            return this.each(function(){
                var $t = this;
                if (!$t.grid ) {return;}
        ...
        navGrid : function (elem, o, pEdit,pAdd,pDel,pSearch, pView) {
            o = $.extend({},$.jgrid.navGrid_setting, $.jgrid.nav, o ||{});
            return this.each(function() {
                if(this.nav) {return;}
                var alertIDs = {themodal: 'alertmod_' + this.p.id, modalhead: 'alerthd_' + this.p.id,modalcontent: 'alertcnt_' + this.p.id},
                    $t = this, twd, tdw;
                // toolbar init
                var $toolbar = $('<div class="btn-group">'), hasToolbar = this.p.toolbar[0];
                $toolbar.wrap('<div class="btn-toolbar">').appendTo($("#t_"+$t.p.id));
                // end
...
//                        $(tbd).append("<div class='ui-pg-div'><span class='ui-icon "+o.addicon+"'></span>"+o.addtext+"</div>");
                        if (hasToolbar){
                            $("<button class='btn btn-sm btn-primary'>"+(o.addtitle || o.addtext)+"</button>").appendTo($toolbar)
                                .click(function(){
                                    if (!$(this).hasClass('ui-state-disabled')) {
                            ...
                            $(tbd).append("<div class='ui-pg-div'><button class='btn btn-xs btn-primary'>"+(o.addtitle || o.addtext)+"</button>");
...
//                        $(tbd).append("<div class='ui-pg-div'><span class='ui-icon "+o.editicon+"'></span>"+o.edittext+"</div>");
                        if (hasToolbar){
                            $("<button class='btn btn-sm btn-primary'>"+(o.edittitle || o.edittext)+"</button>").appendTo($toolbar)
                                .click(function(){
                                    if (!$(this).hasClass('ui-state-disabled')) {
                                        var sr = $t.p.selrow;
                                        if (sr) {
                            ...
                            $(tbd).append("<div class='ui-pg-div'><button class='btn btn-xs btn-primary'>"+(o.edittitle || o.edittext)+"</button>");
                            $("tr",navtbl).append(tbd);
                            $(tbd,navtbl)
...
//                        $(tbd).append("<div class='ui-pg-div'><span class='ui-icon "+o.viewicon+"'></span>"+o.viewtext+"</div>");
                        if (hasToolbar){
                            $("<button class='btn btn-sm btn-primary'>"+(o.viewtitle || o.viewtext)+"</button>").appendTo($toolbar)
                                .click(function(){
                                    if (!$(this).hasClass('ui-state-disabled')) {
                                        var sr = $t.p.selrow;
                                        if (sr) {
                            ...
                            $(tbd).append("<div class='ui-pg-div'><button class='btn btn-xs btn-primary'>"+(o.viewtitle || o.viewtext)+"</button>");
                            $("tr",navtbl).append(tbd);
                            $(tbd,navtbl)
...
//                        $(tbd).append("<div class='ui-pg-div'><span class='ui-icon "+o.delicon+"'></span>"+o.deltext+"</div>");
                        if (hasToolbar){
                            $("<button class='btn btn-sm btn-primary'>"+(o.deltitle || o.deltext)+"</button>").appendTo($toolbar)
                                .click(function(){
                                    if (!$(this).hasClass('ui-state-disabled')) {
                                        var dr;
                                        if($t.p.multiselect) {
                            ...
                            $(tbd).append("<div class='ui-pg-div'><button class='btn btn-xs btn-primary'>"+(o.deltitle || o.deltext)+"</button>");
                            $("tr",navtbl).append(tbd);
                            $(tbd,navtbl)
...
//                        $(tbd).append("<div class='ui-pg-div'><span class='ui-icon "+o.searchicon+"'></span>"+o.searchtext+"</div>");
                        if (hasToolbar){
                            $("<button class='btn btn-sm btn-primary'>"+(o.searchtitle || o.searchtext)+"</button>").appendTo($toolbar)
                                .click(function(){
                                    if (!$(this).hasClass('ui-state-disabled')) {
                            ...
                            $(tbd).append("<div class='ui-pg-div'><button class='btn btn-xs btn-primary'>"+(o.searchtitle || o.searchtext)+"</button>");
                            $("tr",navtbl).append(tbd);
                            $(tbd,navtbl)
...
//                        $(tbd).append("<div class='ui-pg-div'><span class='ui-icon "+o.refreshicon+"'></span>"+o.refreshtext+"</div>");
                        if (hasToolbar){
                            $("<button class='btn btn-sm btn-primary'>"+(o.refreshtitle || o.refreshtext)+"</button>").appendTo($toolbar)
                                .click(function(){
                                    if (!$(this).hasClass('ui-state-disabled')) {
                            ...
                            $(tbd).append("<div class='ui-pg-div'><button class='btn btn-xs btn-primary'>"+(o.refreshtitle || o.refreshtext)+"</button>");
                            $("tr",navtbl).append(tbd);
                            $(tbd,navtbl)
        ...
        navButtonAdd : function (elem, p) {
            ...
            return this.each(function() {
                ...
                // toolbar
                var hasToolbar = $t.p.toolbar[0], $toolbar = $("#t_"+$t.p.id).children(".btn-group");
                // end
                if (findnav) {
                    ...
                    }else if (p.buttonicon.toString().toUpperCase() === "BUTTON"){
                        if (hasToolbar){
                            $("<button class='btn btn-sm btn-primary'>"+p.caption+"</button>").appendTo($toolbar)
                                .click(function(e){
                                    if ($.isFunction(p.onClickButton) ) {p.onClickButton.call($t,e);}
                                });
                        } else{
                            $(tbd).addClass('ui-pg-button ui-corner-all').append("<div class='ui-pg-div'><button class='btn btn-xs btn-primary'>"+p.caption+"</button></div>");
                        }
                    } else	{
