...
<body>
    ...
    <div class="operating-area">
    	...
    	<sys:auth grant="ANNUAL_PLAN_APP_ADD" username="${sessionScope.loginUser.userName}">
    	<div class="button-content">
    ...
    function view(id){
	    $('.index-iframe' , window.parent.document ).attr('src', '${pageContext.request.contextPath}/meetingMgt/annualPlan/annualPlanView.do?id='+id);
	}
    
    function modify(id){
	    $('.index-iframe' , window.parent.document ).attr('src', '${pageContext.request.contextPath}/meetingMgt/annualPlan/annualPlanForm.do?id='+id);
	}
    
    function audit(id){
	    $('.index-iframe' , window.parent.document ).attr('src', '${pageContext.request.contextPath}/meetingMgt/annualPlan/annualPlanApprove.do?id='+id);
	}
    ...
    $(function(){
    	...
    	$('.add-form-btn').click(function() {
  	        $('.index-iframe' , window.parent.document ).attr('src', '${pageContext.request.contextPath}/meetingMgt/annualPlan/annualPlanForm.do');
        });
        ...
        function loadGridData() {
            ...
            dataTable.initialize({
                ...
                "dataSource" : "${pageContext.request.contextPath}/meeting/annualPlanAppGirdData.do",
                ...
                "url" : {
      		      ...
      		      "rmDataUrl" : "${pageContext.request.contextPath}/meeting/removeAnnualPlanAppData.do"
    	           }
    	       });
    ...
    <sys:auth grant="ANNUAL_PLAN_APP_EDIT" username="${sessionScope.loginUser.userName}">
