...
<body>
    ...
    <div class="main-content" data-num="3">
                ...
                <div class="form-content">
                    <form class="form-horizontal">
			            ...
			            <div class="form-group">
			                ...
			                <div class="col-sm-4" data-bind="with: deviceVM">
			                    <input type="text" data-bind="value: managerAlias" name="managerAlias" id="managerAlias" class="form-control" readonly />
			                </div>
			            </div>
                    </form>
                </div>
    ...
    <script>
    	...
    	$(function(){
    		var number = 0;
    	   	...
    	   	function getMaintDate(data, type, row) {
    		...
    		function loadGridData() {
    			//数据列绑定
    			var columns = [
    				{ "mData" : null , "bSortable" : false, "mRender": getNumber},
    				{ "mData" : "maintDate", "bSortable" : false , "mRender": getMaintDate},
    			...
    			dataTable.initialize({
    				...
    				"dataSource" : "${pageContext.request.contextPath}/deviceMgt/devMaintanence/DevMaintanenceGirdData.do",
