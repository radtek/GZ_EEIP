...
<html>
<head>
	<title>电子物证管理-管理人员操作台-文书审批</title>
  	<meta charset="utf-8">
...
<body>
    <div class="crumbs-nav">
        <p class="crumbs-text">
			当前位置：<a>电子物证管理</a><span>></span><a>管理人员操作台</a><span>></span><a>文书审批</a>
        </p>
    </div>
        ...
        <table class="table table-striped table-hover" id="table2">
            ...
            <tbody>
             	<!-- <tr>
            		...
            		<td>非法买卖枪支弹药</td>
            		<td>010501911002015110035</td>
            		<td>2016-4-18</td>
            		<td>83112754</td>
            		<td>待审批</td>
            		<td><a class="operating-btn" title="审批"><i class="fa fa-check-square-o"></i></a></td>
            	</tr>  --> 
            </tbody>
        </table>
    </div>
    ...
    var query="";
	   	...
	   	function writAudit(id){
	   		var url = "${pageContext.request.contextPath}/elecEVIDMgt/managersOperatorStation/clericalApprovalForm.do?id="+id;
	   		$(".index-iframe", window.parent.document).attr("src",url);
        }
	   	function getOperationCol(data, type, row) {
			var html = "";
			html+="<a class=\"operating-btn\" onclick=\"writAudit('" + row.id + "');\" title=\"审批\"><i class=\"fa fa-check-square-o\"></i></a>";
			return html;
		}
    	...
    	function loadGridData() {
    			...
    			dataTable.initialize({
    				...
    				"dataSource" : "${ pageContext.request.contextPath }/elecEVIDMgt/appraisal/LoadListByRoleData.do",
