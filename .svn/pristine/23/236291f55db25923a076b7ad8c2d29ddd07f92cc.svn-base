...
<body>
	    ...
	    <div class="form-content">
	        <form class="form-horizontal">
	            <div class="form-group">
	                ...
	                <div class="col-sm-4">
	                    <div class="bar-code-content" id="bar-code-content">
	                    <span data-bind="with:evidenceVm">
	                    	<input type="text" class="form-control" data-bind="value:sn" />
	                    </span>
					        <div id="bcTarget" class="bar-code-img"></div> 
							<div class="bar-code-text"></div>
	                    </div>
	                </div>
	                <!-- <div class="col-sm-4">
	                    <button type="button" class="btn btn-color1 print-btn"><i class="fa fa-print"></i>打印</button>
	                </div> -->
	            </div>
	            <div class="form-group">
	...
	<script>
		...
		$(function(){
			...
			var evidenceLog = loadData("${pageContext.request.contextPath}/elecEVIDMgt/evidOpLog/getDataByEvidIdAndSpLabel.do",{ "evidId" : evidenceData.id , "spLabel" : 0 });
			...
			$(".img-list").on("click", "img", function(){
		        ...
		        $(".iframe-warehousing", window.parent.document).height(bodyHeight);
		    });
			/*查看图片--结束*/
		}); 
	</script>
