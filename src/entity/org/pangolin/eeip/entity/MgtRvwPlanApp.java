 ...
 */
@Entity
@Table(name = "t_mgt_rvw_plan_app")
public class MgtRvwPlanApp extends BaseEntity implements Serializable {

	private static final long serialVersionUID = 5055361063060557283L;
	...
	/***
	 * 年度内部评审计划（与年度字段拼接，如2017年度内部评审计划）
	 */
	...
	private Integer delFlag = MgtRvwPlanApp.NORMAL;
	
	public MgtRvwPlanApp() {
