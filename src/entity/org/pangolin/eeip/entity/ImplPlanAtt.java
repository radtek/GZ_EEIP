 ...
 */
@Entity
@Table(name = "t_impl_plan_att")
public class ImplPlanAtt extends BaseEntity implements Serializable {

	private static final long serialVersionUID = -3369292873080625050L;
	...
	private Integer delFlag = ImplPlanAtt.NORMAL;
	
	/***
	 * 内部审核实施计划申请ID
	 */
	@Column(name = "fk__impl_plan_app_id", length = 32, nullable = false)
