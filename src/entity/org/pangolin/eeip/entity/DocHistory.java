 ...
 */
@Entity
@Table(name = "t_doc_history")
public class DocHistory extends BaseEntity implements Serializable {

	private static final long serialVersionUID = 5093918086594854264L;
	 ...
	 * 年份
	 */
	@Column(name = "f_year", length = 10, nullable = true)
	private String year;
	...
	private Integer deleteFlag = DocHistory.NORMAL;
