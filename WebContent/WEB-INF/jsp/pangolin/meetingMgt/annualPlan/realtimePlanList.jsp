...
<body>
   <div class="crumbs-nav">
    ...
    <div class="operating-area">
    	...
    	<sys:auth grant="IMPL_PLAN_APP_ADD" username="${sessionScope.loginUser.userName}">
    	<div class="button-content">
    ...
    function view(id){
	    $('.index-iframe' , window.parent.document ).attr('src', '${pageContext.request.contextPath}/meetingMgt/annualPlan/realtimePlanView.do?id='+id);
	}
    
    function modify(id){
	    $('.index-iframe' , window.parent.document ).attr('src', '${pageContext.request.contextPath}/meetingMgt/annualPlan/realtimePlanForm.do?id='+id);
	}
    
    function audit(id){
	    $('.index-iframe' , window.parent.document ).attr('src', '${pageContext.request.contextPath}/meetingMgt/annualPlan/realtimePlanApprove.do?id='+id);
	}
    
    function remove(id){
    	$.ajax({
    		url:'${pageContext.request.contextPath}/meeting/removeImplPlanAppData.do',
    	    type:'post',
    	    datatype:'json',
    	    data:{'id':id},
    	    success:function(){
    ...
    $(function(){
    	...
    	$('.add-form-btn').click(function() {
  	        $('.index-iframe' , window.parent.document ).attr('src', '${pageContext.request.contextPath}/meetingMgt/annualPlan/realtimePlanForm.do');
        });
    	...
    	function getOperationCol(data, type, row) {
     		...
     		html += "<a title='删除' data-toggle=\"modal\" data-target=\"#sysNoticePopup\" onclick=\"setRemovedRealtimeParam('" + row.id + "', '" + row.title + "');\"><i class='fa fa-times'></i></a>";
     		return html;
        }
        ...
        function loadGridData() {
            ...
            dataTable.initialize({
                ...
                "dataSource" : "${pageContext.request.contextPath}/meeting/implPlanAppGirdData.do",
                ...
                "url" : {
      		      ...
      		      "rmDataUrl" : "${pageContext.request.contextPath}/meeting/removeImplPlanAppData.do"
    	           }
    	       });
     ...
     function setRemovedRealtimeParam(id, title) {
      	  $("#rmId").val(id);
  	      $("#rmTitle").val(title);
    ...
    initSystemNoticePopup(function() {
     ...
     <sys:auth grant="IMPL_PLAN_APP_EDIT" username="${sessionScope.loginUser.userName}">
