...
<html>
<head>
	<title>电子物证管理-受理人员操作台-检材交接-领材</title>
  	<meta charset="utf-8">
...
<body>
    <div class="crumbs-nav">
        <p class="crumbs-text">
           	当前位置：<a>电子物证管理</a><span>></span><a>受理人员操作台</a><span>></span><a>检材交接</a><span>></span><a>领材</a>
        </p>
    </div>
	    ...
	    <div class="form-module">
	        ...
	        <div class="form-content">
	            <form class="form-horizontal">
	                ...
	                <div class="form-group">
	                    <label class="col-sm-2 control-label"><span class="required-fields">*</span>领材拍照：</label>
	                    <div class="col-sm-10">
	                        <div id="zyupload" class="zyupload"></div> 
	                    </div>
	                </div>
	                <!-- <div class="form-group">
						<label class="col-sm-2 control-label">领取视频文件：</label>
						<div class="col-sm-4">
