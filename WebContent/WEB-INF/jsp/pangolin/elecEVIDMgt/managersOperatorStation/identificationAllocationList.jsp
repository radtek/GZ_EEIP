...
<html>
<head>
	<title>电子物证管理-管理人员操作台-鉴定分配</title>
  	<meta charset="utf-8">
...
<body>
    <div class="crumbs-nav">
        <p class="crumbs-text">
			当前位置：<a>电子物证管理</a><span>></span><a>管理人员操作台</a><span>></span><a>鉴定分配</a>
        </p>
    </div>
    ...
    <div class="table-content">
        <table class="table table-striped table-hover" id="table2">
            ...
            <!-- 	<tr>
            		...
            		<td>非法买卖枪支弹药</td>
            		<td>01911002015110035</td>
            		<td>2016-4-18</td>
            		<td>83112754</td>
            		<td>待分配</td>
            		<td><a class="operating-btn" title="分配"><i class="fa fa-check-square-o"></i></a></td>
            	</tr> -->
            </tbody>
        </table>
    </div>
    ...
    $(function(){
    	...
    	loadGridData();
	   	...
	   	function allocation(id){
	   		var url = "${pageContext.request.contextPath}/elecEVIDMgt/managersOperatorStation/identificationAllocationForm.do?id="+id;
        	$(".index-iframe", window.parent.document).attr("src",url);
        }
	   	
		function getOperationCol(data, type, row) {
			var html = "";
			html+="<a class=\"operating-btn\" onclick=\"allocation('" + row.id + "');\" title=\"分配\"><i class=\"fa fa-hand-o-right\"></i></a>";
			return html;
		}
    	...
    	function loadGridData() {
    			...
    			//扩展参数
    			var extraParams = [{ "name" : "query", "value" : query}, { "name" : "status", "value" : 5}];
