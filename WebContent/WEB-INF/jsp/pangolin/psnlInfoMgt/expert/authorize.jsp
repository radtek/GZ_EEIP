...
<body>
	<div class="content">		
		<div class="crumbs-nav">
	        <p class="crumbs-text">
	        	当前位置：<a>人员信息管理</a><span>></span><a>专家库</a><span>></span><a>新增</a><span>></span><a>业务能力确认及授权</a>
	        </p>
    	</div>
		...
		<form class="form-horizontal myform">
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input type="text" class="form-control" data-bind="value: dept" readonly required/>
				</div>									
			</div>	
			<div class="form-group">
				<label class="col-sm-2 control-label"><span class="required-fields">*</span>确认时间：</label>
				<div class="col-sm-4">
					<input type="text" class="form-control datetimepicker" data-bind="dateTimePicker: confirmedDate" required />
				</div>						
			</div>		
			<div class="form-group">
				<label class="col-sm-2 control-label"><span class="required-fields">*</span>确认内容：</label>
				<div class="col-sm-10">
			...
			<div class="form-group">
				<label class="col-sm-2 control-label"><span class="required-fields">*</span>确认结果：</label>
				<div class="col-sm-10">
			...
			<div class="form-group">
				<label class="col-sm-2 control-label"><span class="required-fields">*</span>确认人：</label>
				<div class="col-sm-4">
					<input type="text" class="form-control name" data-bind="value: confirmPerson" required />
				</div>
			...
			<div class="form-group">
				<label class="col-sm-2 control-label"><span class="required-fields">*</span>授权意见：</label>
				<div class="col-sm-10">
			...
			<div class="form-group">
				<label class="col-sm-2 control-label"><span class="required-fields">*</span>实验室主任：</label>
				<div class="col-sm-4">
					<input type="text" class="form-control name" data-bind="value: labDirector" required />
				</div>
			
				<label class="col-sm-2 control-label"><span class="required-fields">*</span>授权时间：</label>
				<div class="col-sm-4">
					<input type="text" class="form-control datetimepicker" data-bind="dateTimePicker: authorizationDate" required />
				</div>
			</div>					
	...
	<script>
		$(function(){
			...
			if( "${param.userBasicInfoId}" ){
			  $(".crumbs-text").html("当前位置：<a>人员信息管理</a><span>></span><a>专家库</a><span>></span><a>修改</a><span>></span><a>业务能力确认及授权</a>");
			}
		    ...
		    vm.saveData = function(){
		        ...
		        if ( validateSubmittedData() ) {
		        	bindDataVM();
		        	if (saveData("${pageContext.request.contextPath}/psnlInfo/userAuthorization/saveUserAuthorizationData.do", vm)) {
						saveSuccess();
					} else {
						saveFailure();
					}
