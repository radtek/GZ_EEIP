...
<html>
<head>
    <title>Operation Log List</title>
    <meta charset="utf-8" />
...
<body>
    ...
    <div class="operating-area">
    	<ul class="log-content">
    		...
    		<li><a class="action" data-url="${pageContext.request.contextPath}/system/log/operationLogList.do">操作日志</a></li>
    ...
    <div class="table-content">
        <table class="table table-striped table-hover" id="table2">
          	<thead>
	            <tr>
	              	<th>ID</th>
	              	<th>${ LANG[sessionScope.loginUser.lang]['COL_OPERATION_LOG_TYPE'] }</th>
	              	<th>${ LANG[sessionScope.loginUser.lang]['COL_OPERATION_LOG_MODULE'] }</th>
	              	<th>${ LANG[sessionScope.loginUser.lang]['COL_OPERATION_LOG_DATE'] }</th>
              		<th>${ LANG[sessionScope.loginUser.lang]['COL_OPERATION_LOG_CONTENT'] }</th>
	              	<th>${ LANG[sessionScope.loginUser.lang]['COL_OPERATION_LOG_OPERATOR_NAME'] }</th>
	              	<th>${ LANG[sessionScope.loginUser.lang]['COL_OPERATION_LOG_OPERATOR_ALIAS'] }</th>
	              	<th>${ LANG[sessionScope.loginUser.lang]['COL_OPERATION_LOG_IP_ADDR'] }</th>
    ...
    $(function() {
        ...
        function getFormattedLogType(data, type, row) {
        	if ( data == 0 ) return "${ LANG[sessionScope.loginUser.lang]['BTN_ADD_DATA'] }";
        	if ( data == 1 ) return "${ LANG[sessionScope.loginUser.lang]['BTN_EDIT_DATA'] }";
        	if ( data == 2 ) return "${ LANG[sessionScope.loginUser.lang]['BTN_RM_DATA'] }";
        	return "";
        }
        ...
        function loadGridData() {
            ...
            dataTable.initialize({
              ...
              "dataSource" : "${pageContext.request.contextPath}/system/log/operationLogGridData.do",
    ...
    initSystemNoticePopup(function() {
  	  if($("#rmId").val() == null || $("#rmId").val() == "" || $("#rmId").val() == "undefined"){
  		  ...
  		  $.ajax({
      		  ...
      		  type:'post',
      		  data:{"id":$("#rmId").val(),"logType":1},
      		  datatype:'json',
      		  success:function(data){
      			  window.location.href="${pageContext.request.contextPath}/system/log/operationLogList.do";
      		  }
      	  }); 
  	  }
     ...
     setSystemNoticeContent("${ LANG[sessionScope.loginUser.lang]['RM_OPERATION_LOG_NOTICE'] }&nbsp;?");
    </script>
</body>
</html>