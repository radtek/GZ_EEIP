...
<head>
    ...
    <%-- <link href="<c:url value="/resources/frameworks/pangolin/js/switcher/bootstrap-switch12.min.css" />" rel="stylesheet"> --%>
...
<body>
	<div class="crumbs-nav">
        <p class="crumbs-text">
           	当前位置：<a>系统管理</a><span>></span><a>通知公告</a><span>></span><a>发布</a>
        </p>
    </div>
    <div class="form-content">
        <form class="form-horizontal">
	      	<div class="form-group">
		        <label class="col-sm-2 control-label">${ LANG[sessionScope.loginUser.lang]['COL_NOTE_TITLE'] }：</label>
		  	...
		  	<div class="form-group">
			    <label class="col-sm-2 control-label">${ LANG[sessionScope.loginUser.lang]['COL_NOTE_TYPE'] }：</label>
		        <div class="col-sm-4" data-bind="with: typeVM">
		        	<select id="notificationTypeId" class="form-control" disabled
		  	...
		  	<div class="form-group date-ctrl-excursion" data-bind="with: notificationVM">
		        	...
		        	<div class="col-sm-2">
				  	...
				  	<div class="col-sm-2">
					  	<div id="publishedHour" class="spin">
				          	<input type="text" name="publishedHour" class="spinner" data-min="0" data-max="23" value="0" disabled/>
				  	...
				  	<div class="col-sm-2">
					  	<div id="publishedMin" class="spin">
				            <input type="text" name="publishedMin" class="spinner" data-min="0" data-max="59" value="0" disabled/>
						    <span class="spinnerup"></span>
						    <span class="spinnerdown"></span>
					 	</div>
		        ...
		        <div class="col-sm-2 inputBtn">
			        <div id="publishingMethodDiv">
					   <input id="publishingMethod" type="checkbox" disabled/>
		  	...
		  	<div class="form-group date-ctrl-excursion" data-bind="with: notificationVM">
		        ...
		        <div class="col-sm-2 inputBtn">
			        <div id="timelinessDivDiv">
					   <input id="timeliness" type="checkbox" disabled/>
					   <span style="width: 5px;">&nbsp;&nbsp;${ LANG[sessionScope.loginUser.lang]['COL_NOTE_NEVER_INVALID'] }&nbsp;&nbsp;</span>
					</div>
		        </div>
	      	</div>
	      	<%-- <div class="form-group" data-bind="with: notificationVM">
			    <label class="col-sm-2 control-label">${ LANG[sessionScope.loginUser.lang]['COL_NOTE_EXPIRED_DATE'] }：</label>
		        <div class="col-sm-4">
	      	...
	      	<div class="form-group formTextarea" data-bind="with: notificationVM">
	        	<textarea id="noteContent" data-bind="value: content" name="noteContent" readonly></textarea>
		  	</div>
    ...
    <div class="btn-content">
        ...
        <button class="btn btn-color1 " data-bind="click: saveData"><i class="fa fa-check"></i>发布</button>
    </div>
    ...
    <%-- <div class="panel panel-default">
  		<div class="panel-heading">
			<p class="headPosition">
				...
				<i>/</i><a href="${pageContext.request.contextPath}/system/notification/notificationList.do">${ LANG[sessionScope.loginUser.lang]['MODULE_FUNC_NOTE_MGT'] }</a>
				<i>/</i>${ LANG[sessionScope.loginUser.lang]['ADD_NOTE_DATA'] }
			</p>
		</div>
		<div class="panel-body panel-body-nopadding">
		    <form class="form-horizontal form-bordered">
		      	<div class="form-group">
			        <label class="col-sm-2 control-label"><span class="errors">*</span>${ LANG[sessionScope.loginUser.lang]['COL_NOTE_TITLE'] }</label>
			        <div class="col-sm-8" data-bind="with: notificationVM">
					  <input type="text" 
					         name="title" 
			  	...
			  	<div class="form-group">
				    <label class="col-sm-2 control-label"><span class="errors">*</span>${ LANG[sessionScope.loginUser.lang]['COL_NOTE_TYPE'] }</label>
			        <div class="col-sm-8" data-bind="with: typeVM">
				    	<div class="navbar navbarStyle1" role="navigation">
						  <div class="navbar-form" role="search">
					        <div class="form-group">
					          <select id="notificationTypeId" 
					                  class="form-control"
					                  data-bind="options: typeList, 
					                             optionsValue: 'id', 
					                             optionsText: 'name', 
      ...
      $(function() {	
          ...
          vm.saveData = function() {
        	  ...
        	  $.ajax ({
    			  ...
    			  cache: false,
    			  async: false, 
    			  data: { "notificationId" : noteData.id, "status" : 1 },
