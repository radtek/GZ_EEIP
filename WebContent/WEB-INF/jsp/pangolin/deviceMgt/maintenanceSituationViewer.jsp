...
<!--                     <button class="btn btn-color1 add-form-btn"><i class="fa fa-plus"></i>申请</button> -->
    ...
    <script>
        ...
        function view(AdjId){
        	var url = "${pageContext.request.contextPath}/deviceMgt/maintenanceSituationViewById.do?id="+id+"&AdjId="+AdjId;
    	...
    	$(function(){
    		var deviceDateSource = loadData("${ pageContext.request.contextPath }/deviceMgt/device/loadDeviceData.do", { "id" : id });
    	   	...
    	   	function getMfrName(data, type, row){
    	   		return deviceDateSource.mfrName;
    	   	}
    		...
    		function loadGridData() {
    			...
    			var columns = [
    				...
    				{ "mData" : null , "bSortable" : false, "mRender": getMfrName },
    			...
    			dataTable.initialize({
    				...
    				"dataSource" : "${ pageContext.request.contextPath }/deviceMgt/devAdjustmentSitn/devAdjustmentSitnGirdData.do",
