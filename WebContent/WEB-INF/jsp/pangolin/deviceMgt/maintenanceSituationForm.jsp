...
<body>
			        ...
			        <form class="form-horizontal">
			            ...
			            <div class="form-group">
			                ...
			                <div class="col-sm-4" data-bind="with: devAdjAppVM">
			                    <input type="text" data-bind="value: budget" name="cost" id="cost" class="form-control" required />
			                </div>
			            </div>
			            <div class="form-group">
			                <label class="col-sm-2 control-label">情况说明：</label>
			                <div class="col-sm-10" data-bind="with:AdjustmentSitnVM">
			                	<textarea rows="8" data-bind="value:situation" name="situation" id="situation" cols="" class="form-control"></textarea>
			                </div>
			            </div>
			            <div class="form-group">
			                <label class="col-sm-2 control-label"><span class="required-fields">*</span>报送人：</label>
			                ...
			                <label class="col-sm-2 control-label"><span class="required-fields">*</span>报送时间：</label>
			                <div class="col-sm-4" data-bind="with:AdjustmentSitnVM">
    ...
    <script>
	    ...
	    $("#radio1").click(function(){
	    	AdjustmentSitnDateVM.type = 0;
	    })
	    $("#radio2").click(function(){
	    	AdjustmentSitnDateVM.type = 1;
	    })
	    $("#radio3").click(function(){
	    	AdjustmentSitnDateVM.type = 2;
	    })
		...
		var AdjustmentSitnDate = loadData("${ pageContext.request.contextPath }/deviceMgt/devAdjustmentSitn/loadDeviceData.do", {"id" : " " }); //空对象
        
		var userName = "${sessionScope.loginUser.userName}";
		var userId = "${sessionScope.loginUser.userId}";
		var userAlias = "${sessionScope.loginUser.userAlias}";
		var id = devAdjAppData.deviceId;
        ...
        AdjustmentSitnDateVM.reporterAlias = userAlias;
        AdjustmentSitnDateVM.createdDate = new Date();
        ...
        vm.saveData = function(){
            ...
            if(validateSubmittedData()){
            	...
            	if ( saveData("${ pageContext.request.contextPath }/deviceMgt/devAdjustmentSitn/saveDeviceData.do", AdjustmentSitnDateVM) ) {
            		saveSuccess("${pageContext.request.contextPath}/deviceMgt/maintenanceSituationViewer.do?id="+id);
    	    	}else{
	    ...
	    function bindDataToVM(){
	    	if(AdjustmentSitnDate.id == "" || AdjustmentSitnDate.id == undefined || AdjustmentSitnDate.id == null){   //没有ID就是新增
	    		AdjustmentSitnDateVM.creatorName = userName;
	    		AdjustmentSitnDateVM.creatorId = userId;
	    		AdjustmentSitnDateVM.creatorAlias = userAlias;
	    		AdjustmentSitnDateVM.deviceId = id;
	    		AdjustmentSitnDateVM.cost = $("#cost").val();
	    		AdjustmentSitnDateVM.type = devAdjAppData.type;
	    		AdjustmentSitnDateVM.reporterId = userId;
	    		AdjustmentSitnDateVM.reporterName = userName;
	    		AdjustmentSitnDateVM.status = 1; //待审批
	    	}
	    }
