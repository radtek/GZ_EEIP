    ...
    <div class="form-content">
        <form class="form-horizontal">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10" data-bind="with:AdjustmentSitnVM">
                	<textarea rows="8" data-bind="value: acceptance" name="acceptance" id="acceptance" cols="" class="form-control shenheren" readonly></textarea>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10" data-bind="with:AdjustmentSitnVM">
                	<textarea rows="8"data-bind="value: opinion" name="opinion" id="opinion" cols="" class="form-control zhuren" readonly></textarea>
                </div>
            </div>
            <div class="form-group">
