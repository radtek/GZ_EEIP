...
<body>
    ...
    <script type="text/javascript">
        ...
        DevAdjPlanDataVM.approverAlias = userAlias;
        DevAdjPlanDataVM.approvedDate = new Date();
    	...
    	$(function(){
    		...
    		function loadGridData() {
    			...
    			var columns = [
    				...
    				{ "mData" : null , "bSortable" : false ,"mRender": getType},
    				{ "mData" : null , "bSortable" : false ,"mRender": getIdf},
    				{ "mData" : "method", "bSortable" : false},
    				{ "mData" : "inspectedDate", "bSortable" : false,"mRender": getDate},
    				{ "mData" : "principalAlias", "bSortable" : false },
...
//     					"rmDataUrl" : "/eeip/meeting/meetingApp/removeMeetingAppData.do"
		...
		$(".agree").click(function(){
	        ...
	        if(validateSubmittedData()){
	        	DevAdjPlanDataVM.approverId = userId;
				DevAdjPlanDataVM.approverName = userName;
				DevAdjPlanDataVM.approverAlias = userAlias;
				DevAdjPlanDataVM.status = 2;
	        	if ( saveData("${ pageContext.request.contextPath }/deviceMgt/devAdjPlan/saveDevAdjPlanData.do", DevAdjPlanDataVM) ) {
