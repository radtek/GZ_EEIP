...
<body>
	<div class="crumbs-nav">
        <p class="crumbs-text">
           	当前位置：<a>取证及流程管理</a><span>></span><a>在库检材</a><span>></span><a>查看</a>
        </p>
    </div>
    ...
    <%-- <div class="tabs-list" id="handover">
    	<jsp:include page="/common/handoverRecordView.jsp"></jsp:include>
    </div> --%>
	<script>
       ...
       // var evidOpLogAtt = loadData("${pageContext.request.contextPath}/elecEVIDMgt/evidOpLogAtt/getEvidOpLogAttByEvidenceId.do",{ "evidenceId" : evidenceData.id });
