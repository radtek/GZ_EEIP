...
.emain { margin-top:15px; width:605px; font-size:18px; margin:0 auto; }
...
<div class="page_error">
	<div class="error_title"><span>403</span>&nbsp;&nbsp;Forbidden</div><hr>
	<div class="emain">The web server is configured to not list the contents of this directory !</div>
