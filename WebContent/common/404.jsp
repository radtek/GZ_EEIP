...
.emain { margin-top:15px; width:610px; font-size:18px; margin:0 auto; }
...
<div class="page_error">
	<div class="error_title"><span>404</span>&nbsp;&nbsp;Page Not Found</div><hr>
	<div class="emain">The page you are looking for doesn't exist or an other error occurred !</div>
